...
INSERT INTO "new_Exam" ("createdAt", "id", "observations", "patientId", "result", "status", "userId", "validated", "validatedAt", "validatorId") SELECT "createdAt", "id", "observations", "patientId", "result", "status", "userId", "validated", "validatedAt", "validatorId" FROM "Exam";
DROP TABLE "Exam";
